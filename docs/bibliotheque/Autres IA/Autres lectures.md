...
Il y est dit que le nouveau [LLM](/docs/installation/En-savoir-plus/glossaire#LLM) (langage modèle à grande échelle) médical de Google surpasse les médecins lors de consultations textuelles en double aveugle.

Le [LLM](/docs/installation/En-savoir-plus/glossaire#LLM) a été entraîné via des simulations d'auto-apprentissage couvrant diverses maladies, spécialités et contextes.
