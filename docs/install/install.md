...
Je vous conseille d’installer la dernière version stable d’Ollama, qui inclut désormais une interface graphique vous permettant de discuter très facilement avec un LLM.

Voici **[le lien de téléchargement officiel](https://ollama.com/download)** pour obtenir la version la plus récente.
