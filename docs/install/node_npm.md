...
2. Téléchargez Node.js : Vous pouvez télécharger Node.js en cliquant [ici](https://nodejs.org/fr/download).
...
5. Ces commandes afficheront les versions de Node.js et npm respectivement.

6. Mise à jour de npm : Si vous souhaitez mettre à jour npm à sa dernière version, télécharger à nouveau l'installeur de Node et relancer-le tout simplement.
